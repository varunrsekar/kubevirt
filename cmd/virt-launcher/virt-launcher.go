...
const defaultStartTimeout = 30 * time.Minute
...
func main() {
	...
	gracePeriodSeconds := pflag.Int("grace-period-seconds", 3000, "Grace period to observe before sending SIGTERM to vmi process")
